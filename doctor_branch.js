module.exports = function(){
  ...
  // Display all doctor/branch relationships for doctor_branch page
    ...
    function getDocBranch(res, mysql, context, complete){
        mysql.pool.query("SELECT b.Name, CONCAT(doc.Fname,' ',doc.Lname) FROM Hosp_Branch b INNER JOIN Hosp_Doctor_Branch db ON b.Id = db.BId INNER JOIN Hosp_Doctor doc ON doc.Id = db.DocId ORDER BY `Branch`, `Doctor`;", function(error, results, fields){
            if(error){
